    ...
    <footer id="footer">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="bx bx-chevron-right"></i> <a href="../Rumah-duka.php">Rumah Duka</a></li>
        ...
        <div class="container d-lg-flex py-4">
            ...
            <div class="social-links text-center text-lg-right pt-3 pt-lg-0">
                ...
                <a href="https://wa.me/<?php echo $sosmed['wa']; ?>" class="whatsapp"><i class="bx bxl-whatsapp"></i></a>
